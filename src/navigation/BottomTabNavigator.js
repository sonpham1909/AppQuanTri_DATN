  ...
  return (
    ...
    >
      ...
      <Tab.Screen 
        ...
        options={{ title: 'Yêu thích',      headerTitleAlign: 'center',  // Canh giữa tiêu đề
        }
      ...
      <Tab.Screen 
        ...
        options={{ title: 'Thông báo',      headerTitleAlign: 'center',  // Canh giữa tiêu đề
        }} 
      />
      <Tab.Screen 
        name="Cá nhân" 
        component={Personal} 
        options={{ title: 'Cá nhân',      headerTitleAlign: 'center',  // Canh giữa tiêu đề
        }} 
      />
    </Tab.Navigator>
  );
